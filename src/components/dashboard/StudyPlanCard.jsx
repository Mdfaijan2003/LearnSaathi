...
function StudyCard({ item, visible }) {
  ...
  return (
    <div
      ...
      className="relative flex-1 rounded-2xl p-5 cursor-pointer overflow-hidden"
      style={{
    ...
    >
      ...
      {/* Icon */}
      <div className={`w-11 h-11 rounded-xl flex items-center justify-center mb-6 ${item.iconBg} shadow-lg`}>
        {item.icon}
      </div>

      {/* Text */}
      <p className="text-white font-bold text-[16px] leading-snug tracking-tight mb-1">
        {item.label}
      </p>
...
export default function AIStudyPlan() {
  ...
  return (
    <div >
      {/* Outer card */}
      <div
        className="relative w-[800px] max-w-3xl rounded-3xl overflow-hidden"
        style={{
      ...
      >
        ...
        <div className="relative z-10 p-6">
          ...
          <div className="flex items-center justify-between mb-6">
            ...
            >
              {/* Star icon */}
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center shadow-[0_4px_16px_rgba(249,115,22,0.4)] shrink-0">
                <svg width="22" height="22" viewBox="0 0 24 24" fill="white">
              ...
              <div>
                <h2 className="text-white font-extrabold text-[18px] tracking-tight leading-tight">
                  Today's AI Study Plan
                </h2>
                <p className="text-gray-400 text-[13px] mt-0.5">Personalized for your exam goals</p>
              </div>
            </div>

            {/* Generate button */}
            <button
              className="bg-gradient-to-r from-orange-500 to-orange-600 hover:from-orange-400 hover:to-orange-500 text-white font-bold text-[14px] px-5 py-2.5 rounded-xl shadow-[0_4px_20px_rgba(249,115,22,0.4)] hover:shadow-[0_6px_28px_rgba(249,115,22,0.55)] hover:scale-105 active:scale-95 transition-all duration-200"
              style={{
                opacity: visible ? 1 : 0,
